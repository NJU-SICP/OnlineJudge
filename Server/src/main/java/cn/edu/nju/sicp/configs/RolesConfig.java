...
public final class RolesConfig {
    ...
    static {
        ...
        grantedAuthoritiesMap.put(OP_USER_READ, List.of(ROLE_ADMIN, ROLE_TEACHER, ROLE_STAFF, ROLE_SENIOR));
        ...
        grantedAuthoritiesMap.put(OP_ASSIGNMENT_READ_BEGUN, List.of(ROLE_ADMIN, ROLE_TEACHER, ROLE_STAFF, ROLE_SENIOR, ROLE_STUDENT));
        ...
        grantedAuthoritiesMap.put(OP_EXTENSION_READ, List.of(ROLE_ADMIN, ROLE_TEACHER, ROLE_STAFF, ROLE_SENIOR));
        ...
        grantedAuthoritiesMap.put(OP_BACKUP_READ_SELF, List.of(ROLE_ADMIN, ROLE_TEACHER, ROLE_STAFF, ROLE_SENIOR, ROLE_STUDENT));
        grantedAuthoritiesMap.put(OP_BACKUP_READ_ALL, List.of(ROLE_ADMIN, ROLE_TEACHER, ROLE_STAFF, ROLE_SENIOR));
        grantedAuthoritiesMap.put(OP_BACKUP_CREATE, List.of(ROLE_ADMIN, ROLE_TEACHER, ROLE_STAFF, ROLE_STUDENT));
        grantedAuthoritiesMap.put(OP_BACKUP_DELETE, List.of(ROLE_ADMIN));
        grantedAuthoritiesMap.put(OP_PLAGIARISM_READ_ALL, List.of(ROLE_ADMIN, ROLE_TEACHER, ROLE_STAFF, ROLE_SENIOR));
        grantedAuthoritiesMap.put(OP_PLAGIARISM_READ_SELF, List.of(ROLE_ADMIN, ROLE_TEACHER, ROLE_STAFF, ROLE_SENIOR, ROLE_STUDENT));
        ...
        grantedAuthoritiesMap.put(OP_SCORE_READ_SELF, List.of(ROLE_ADMIN, ROLE_TEACHER, ROLE_STAFF, ROLE_STUDENT));
        grantedAuthoritiesMap.put(OP_SCORE_READ_ALL, List.of(ROLE_ADMIN, ROLE_TEACHER, ROLE_STAFF, ROLE_SENIOR));
    }
